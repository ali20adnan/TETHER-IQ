...
function MaintenancePage({ messageAr, messageEn }) {
  ...
  return (
    <div className="maintenance-page" style={{
      ...
      <div style={{ width: '80px', height: '80px', borderRadius: '50%', background: 'rgba(63,104,254,0.1)', border: '2px solid rgba(63,104,254,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="var(--accent-primary,#3F68FE)" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
          <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>
        </svg>
      </div>
      <h1 style={{ color: 'var(--accent-primary,#3F68FE)', fontSize: '2rem', margin: 0 }}>
      ...
      <button onClick={() => setLang(l => l === 'ar' ? 'en' : 'ar')}
        style={{ background: 'transparent', border: '1px solid rgba(63,104,254,0.35)', color: 'var(--accent-primary,#3F68FE)',
